...
create or replace view public.compat_risk_snapshot_v41 as
select
    portfolio_id,
    ...
    gross_exposure_pct,
    liquidity_score
from public.portfolio_risk_v41;

grant select on public.compat_risk_snapshot_v41 to anon, authenticated;
notify pgrst, 'reload schema';
select 'GPT Quant Enterprise 4.4.2 Compatibility Pack setup complete' as result;
