...
Write-Host " Paper Trading 404 Fix v1"
Write-Host " Missing gpt_quant_v91_paper_sessions"
Write-Host "============================================================"
...
$generatorPath = Join-Path $automationDir "gpt_quant_v91_paper_trading_404_fix_v1.py"
$sqlPath = Join-Path $supabaseDir "GPT_QUANT_V91_PAPER_TRADING_404_FIX_V1.sql"
$validatorPath = Join-Path $automationDir "gpt_quant_v91_paper_trading_schema_check_v1.py"
$workflowPath = Join-Path $workflowDir "gpt-quant-v91-paper-trading-404-fix-v1.yml"
...
$workflow = @'
name: GPT Quant V9.1 Paper Trading 404 Fix v1 - Schema Check
  ...
  paper-trading-schema-check-v1:
    ...
    steps:
      ...
      - name: Validate Paper Trading session schema endpoint
        run: python automation/gpt_quant_v91_paper_trading_schema_check_v1.py
'@
...
Write-Host ""
Write-Host "Generating Paper Trading SQL from current upsert payload..."
...
Write-Host "2. Open:"
Write-Host "   supabase\GPT_QUANT_V91_PAPER_TRADING_404_FIX_V1.sql"
...
Write-Host "   Actions -> GPT Quant V9.1 Paper Trading 404 Fix v1 - Schema Check"
Write-Host ""
Write-Host "If green:"
