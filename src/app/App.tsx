...
import Enterprise46Analytics from "../pages/Enterprise46Analytics";
...
export default function App() {
  const [page, setPage] = useState<Page>("enterprise46");
  ...
  } else if (page === "enterprise46") {
    content = <Enterprise46Analytics />;
  ...
  return (
    <div className="app-shell">
      <header className="topbar">
        <div>
          <div className="brand">GPT QUANT ENTERPRISE 4.6 FOUNDATION</div>
