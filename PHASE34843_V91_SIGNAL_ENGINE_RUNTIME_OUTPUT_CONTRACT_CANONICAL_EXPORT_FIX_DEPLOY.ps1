...
<#
PHASE34843_V91_SIGNAL_ENGINE_RUNTIME_OUTPUT_CONTRACT_CANONICAL_EXPORT_FIX_DEPLOY.ps1

GPT Quant V9.2
Phase 3.4.8.4.3 — V9.1 Signal Engine Runtime Output Contract + Canonical Export Fix
...
Section "GPT Quant V9.2 — Phase 3.4.8.4.3 Signal Engine Runtime Output Contract Fix"
...
foreach ($needle in $needles) {
    if (-not $source.Contains($needle)) {
        Fail "Required Phase 3.4.8.4.3 token missing: $needle"
    }
}

Write-Host "Phase 3.4.8.4.3 static contract scan: PASS" -ForegroundColor Green
