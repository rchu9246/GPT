...
Write-Host " Market State Persistence Fix v3"
Write-Host " Canonical Market Source Discovery"
Write-Host "============================================================"
...
$workflow = @'
name: GPT Quant Phase 3.4.2.1 - Market State Persistence Fix v3
...
concurrency:
  group: gpt-quant-phase3421-market-state-persistence-v3
...
jobs:
  market-state-persistence:
    ...
    steps:
      ...
      - name: Validate v3 safety boundary
        shell: bash
        run: |
          set -euo pipefail
          test -n "${SUPABASE_URL:-}"
      ...
      - name: Run Phase 3.4.2.1 v3 Canonical Market Source Discovery
        run: python automation/v92/paper_trading_phase3421_market_state_persistence_fix.py

      - name: Upload v3 market-state evidence
        if: always()
        uses: actions/upload-artifact@v4
        with:
          name: phase3421-market-state-v3-${{ github.run_id }}
          path: |
            phase3421_output/
...
Write-Host ""
Write-Host "============================================================"
Write-Host " PHASE 3.4.2.1 v3 READY"
Write-Host "============================================================"
...
Write-Host ""
Write-Host "Discovery order:"
Write-Host "  1. Known Phase 2.1 / market JSON outputs"
Write-Host "  2. Discovered local JSON evidence"
Write-Host "  3. Markdown/text summaries"
Write-Host "  4. Supabase fallback discovery"
Write-Host ""
Write-Host "Safety:"
